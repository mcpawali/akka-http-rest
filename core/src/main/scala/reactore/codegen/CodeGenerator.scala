...
import reactore.entities.{Employee, Tables, User}
...
object CodeGenerator extends App {
  ...
  val ddlQuery = entities.Tables.schema.create
  ...
  def advancedSetup: DBIOAction[Unit, NoStream, Write with Schema] = {
    DBIO.seq(
      entities.Tables.schema.create,
      Tables.employeeTable forceInsertAll SampleData.employeesSampleData,
      entities.Tables.userTable ++= SampleData.userSampleData
    )
  }
...
object SampleData {
  ...
  val userSampleData = Seq(
    entities.User(0, "master", "sachin@gmail.com", "india", false, 100),
    entities.User(0, "wall", "dravid@gmail.com", "india", false, 101),
    entities.User(0, "dada", "ganguly@gmail.com", "india", false, 102),
    entities.User(0, "saina", "saina@gmail.com", "india", false, 103),
