...
//import reactore.core.{DriverHelper, User}
//import reactore.repository.{Tables, UserRepository}
...
//  val q = core.Tables.employeeTable.filter(_.isDeleted === false)
//
//  1 to 100 map { x=>
//    val res = DriverHelper.db.run(q.length.result)
//    res recover {
